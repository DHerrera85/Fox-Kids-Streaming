  ...
  getDefaultIndex() {
    ...
    return {
      ...
      "series": [
        ...
        {"id": "x-men", "name": "X-Men", "type": "series", "category": "Comics", "image": "img/marvel/x-men-animated-280 X 420.jpg", "url": "serie.html?id=x-men", "tags": ["acción", "marvel"], "characters": ["x-men"], "searchTerms": ["x-men", "xmen", "marvel"]},
